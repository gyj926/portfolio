...
// 세션값 가져오기
	...
	MemberVo vo = dao.getMemberById(memberId);
...
<div class="info">
<form action="adminUpdatePro.jsp" method = "post" name="userInfo">
	...
	<input type="submit" value="수정하기" class="updateButton" >
	<input type="button" value="취소" onclick="location='/member/list.jsp'">
</form>
</div>
